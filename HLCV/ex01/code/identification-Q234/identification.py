...
# num_bins_color = 5
# plt.subplot(1, 2, 2)
# hist_rgb1 = histogram_module.rgb_hist(
...
#                         hist2 = hist2[0]
#
#                     D[hidx, didx] = dist_module.get_dist_by_name(
#                         hist1, hist2, distance_types[didx])
#
...
#     model_images, query_images, eval_dist_type, eval_hist_type, eval_num_bins)
#
#
...
#     model_images, query_images_vis, eval_dist_type, eval_hist_type, eval_num_bins)
#
...
rpc_module.compare_dist_rpc(model_images, query_images, [
                            'chi2', 'intersect', 'l2'], 'rg', eval_num_bins, ['r', 'g', 'b'])
...
plt.figure()
rpc_module.compare_dist_rpc(model_images, query_images, [
                            'chi2', 'intersect', 'l2'], 'rgb', eval_num_bins / 2, ['r', 'g', 'b'])
plt.title('RGB histograms')
plt.show()

plt.figure()
rpc_module.compare_dist_rpc(model_images, query_images, [
                            'chi2', 'intersect', 'l2'], 'dxdy', eval_num_bins, ['r', 'g', 'b'])
